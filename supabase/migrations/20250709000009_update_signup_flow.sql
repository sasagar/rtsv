...
-- 2. Create the new function to handle user creation with invite code
...
BEGIN
  ...
  -- If the code is valid, proceed to insert the profile
...
-- 4. Drop the old, unused signup function
DROP FUNCTION IF EXISTS public.signup_with_invite(text, text, text);
